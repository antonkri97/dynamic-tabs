...
export class TabsComponent implements AfterContentInit {
  ...
  @ViewChild(DynamicTabAnchorDirective) dynamicTabAnchorPlaceholder: DynamicTabAnchorDirective;
  ...
  openTab(title: string, template, data, isCloseable = false) {
    ...
    const viewContainerRef = this.dynamicTabAnchorPlaceholder.viewContainer;
